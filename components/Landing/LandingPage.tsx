      ...
      <section className="relative mx-auto flex w-full max-w-6xl flex-col gap-12 px-6 pb-24 pt-16 md:flex-row md:items-center md:gap-16">
        ...
        <div className="flex-1">
          ...
          <p className="mt-6 max-w-xl text-sm md:text-base text-slate-700 leading-relaxed">
            まずはブラウザだけで4象限ボードを無料で体験できます。
            <br />
            Gmail連携とAIの一括整理は Pro プランで利用できます。
          </p>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-md">
                ...
                >
                  ...
                  <div className="space-y-1.5">
                    {q.tasks.slice(0, 2).map((task, i) => (
                      <div
                        key={i}
                        className={`rounded-md border ${q.taskBorder} ${q.taskBg} px-2 py-2 text-[11px] text-slate-700`}
                      >
                        {task}
                      </div>
                    ))}
            ...
            <div className="mt-4 border-t border-slate-200 pt-4">
              <div className="flex items-center gap-2 mb-2">
                <span className="rounded-full bg-sky-50 px-3 py-1 text-[10px] text-sky-600 border border-sky-200 font-semibold">
                  AI 提案
                </span>
              </div>
              <p className="text-[11px] text-slate-600 leading-relaxed">
                タスクのタイトルや締切から、AI
                が自動で「どの象限に置くべきか」を提案します。迷ったときは、AI
                と会話しながらタスクの整理を進めることもできます。
              </p>
            </div>
          </div>
        </div>
